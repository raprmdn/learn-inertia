...
export default function FormUser({errors, data, submit, submitLabel, onChange}) {
    ...
    return (
        <form onSubmit={submit}>
            <div className="mb-3">
                ...
                {errors && <small className="text-danger mt-1">{errors.name}</small>}
            </div>
            <div className="row">
                <div className="col-md-6">
                    <div className="mb-3">
                        ...
                        {errors && <small className="text-danger mt-1">{errors.email}</small>}
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="mb-3">
                        ...
                        {errors && <small className="text-danger mt-1">{errors.username}</small>}
                    </div>
                </div>
            </div>
            <div className="row">
                <div className="col-md-6">
                    <div className="mb-3">
                        ...
                        {errors && <small className="text-danger mt-1">{errors.location}</small>}
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="mb-3">
                        ...
                        {errors && <small className="text-danger mt-1">{errors.password}</small>}
                    </div>
                </div>
            </div>
